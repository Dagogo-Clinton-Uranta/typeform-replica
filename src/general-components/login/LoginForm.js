...
export default function LoginForm() {
  ...
  return (
    <>
     <form onSubmit={userSignin} style={{scale:"0.8"}}>
      <Stack spacing={3}>
      ...
      <LoadingButton fullWidth size="large" type="submit" disabled={loading} style={{backgroundColor: /*'#2E2779'*/ '#000000', color: 'white'}}>
