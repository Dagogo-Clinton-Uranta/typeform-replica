...
import MAN from 'src/assets/images/man.jpeg'
...
export default function AccountPopover() {
  ...
  return (
    <>
      ...
      >
        <Avatar src={user?user.imageUrl:MAN} alt="photoURL" />
      </IconButton>
      ...
      >
        ...
        >
          ...
          <Typography variant="subtitle2" noWrap>
            {`${user && user.firstName?user.firstName:"John"}` + " " + `${user && user.lastName?user.lastName:"Smith"}`}
          </Typography>
          <Typography variant="body2" sx={{ color: 'text.secondary' }} noWrap>
            {user && user.email? user.email:"user@jobprep.com"}
          </Typography>
        </Box>
        </Grid>
